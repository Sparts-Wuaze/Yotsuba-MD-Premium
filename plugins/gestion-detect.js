...
const nombre = `> Hello chicos`
const foto = `> Hello chicos`
const edit = `> Hello chicos`
const newlink = `> Hello chicos`
const status = `> Hello chicos`
const admingp = `💜 Notice:\n\n> @${users.split('@')[0]} *You are now an administrator of this group* because *@${user.split('@')[0]},* has just given you administrative privileges.`
const noadmingp = `💜 Notice:\n\n> @${users.split('@')[0]} *I am no longer an administrator of this group* because *@${user.split('@')[0]},* removed their privileges.`
